    ...
    <>
      ...
      <h1 className='font-bold text-center text-3xl'>iTask - Manage Your Todos At One Place</h1>
        <div className="addTodo my-5 flex flex-col gap-5">
          ...
          <input onChange={handleChange} value={todo} type="text" className='w-full rounded-full px-5 py-1 outline-none' />
          <button onClick={handleAdd} disabled={todo.length<=3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-red-500 p-2 py-1 text-sm font-bold text-white rounded-md'>ADD</button>
        </div>
